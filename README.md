...
This repo contains my notes for SE222
...
_Algorithm_ by Professor W.G. Shen, 2021 Fall
...
- `\hw` contains all the homework, I think some problems are pretty funny.
- `\code` includes all labs, projects and industry code these days.
- `\slides` includes all materials presented in class by Prof.
